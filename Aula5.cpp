...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	//O IF E ELSE CONDICIONAM O QUE O USUÁRIO DIGITA, POR EXEMPLO, SE O COD2 DIGITADO PELO USUÁRIO FOR IGUAL A TRUE ELE IRÁ EXECUTARÁ A IMAGEM ABAIXO NA TELA.
	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
		cout << "	      |||||    " << endl;
	...
	//CASO CONTRÁRIO, EXECUTARÁ ESSA IMAGEM ABAIXO.
	else
	{
		cout << "	       ____	" << endl;
		cout << "	      |   |    " << endl;
	...
	//SE O COD4 DIGITADO PELO USUÁRIO FOR IGUAL A TRUE ELE IRÁ EXECUTARÁ A IMAGEM ABAIXO NA TELA.
	if (cod4 == true)
	{
		cout << "	       | |                     |||||" << endl;
		cout << "	       | |                     |||||" << endl;
	...
	//SE O COD1 DIGITADO PELO USUÁRIO FOR IGUAL A TRUE ELE IRÁ EXECUTARÁ TAIS PONTOS DA IMAGEM ABAIXO NA TELA.
	if (cod1 == true)
	{
		cout << "|||||	|\\:\\ \\/__/|\\:\\/:/  /|\\:\\/:/  /|\\:\\:\\/  /|	" << endl;
		cout << "|||||   | \\:\\__\\  | \\::/  / | \\::/  / | \\:\\/  / |	" << endl;
	}
	//CASO CONTRÁRIO, EXECUTARÁ ESSES PONTOS DA IMAGEM ABAIXO.
	else
	{
		cout << "|   |	|\\:\\ \\/__/|\\:\\/:/  /|\\:\\/:/  /|\\:\\:\\/  /|	" << endl;
		cout << "|___|   | \\:\\__\\  | \\::/  / | \\::/  / | \\:\\/  / |	" << endl;
	...
	//SE O COD3 DIGITADO PELO USUÁRIO FOR IGUAL A TRUE ELE IRÁ EXECUTARÁ TAIS PONTOS DA IMAGEM ABAIXO NA TELA.
	if (cod3 == true)
	{
		cout << "                        |||||___| |				" << endl;
		cout << "                        |||||_____|				" << endl;
